...
<body>
    ...
    <section class="ftco-about d-md-flex">
        ...
        <div class="one-half ftco-animate">
            ...
            <div>
                <p>Seja Bem Vindo a Pizzaria Villa Verona onde é sempre um prazer poder atende-lo, Fique a vontade para
                    olhar nosso cardapio <br>é sempre bom ressaltar que sua opinião e muito importante para nós </p>
            </div>
        </div>
    </section>
    ...
    <section class="ftco-section">
        ...
        <div class="container-wrap">
            <div class="row no-gutters d-flex" style="margin-bottom: 20px">
